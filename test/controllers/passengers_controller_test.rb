...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { address: @passenger.address, city: @passenger.city, father_name: @passenger.father_name, name: @passenger.name }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { address: @passenger.address, city: @passenger.city, father_name: @passenger.father_name, name: @passenger.name }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
